...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        try:
            ...
            logging.info("Numerical colummns standard scaling completed")
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info("Split the the data into Indepenedent and Depenedent features")
            ...
            logging.info("Standardized the input features")
