...
#Class to Inject the data into files
class DataIngestion:
    def __init__(self):
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            ...
            #create a directory name artifacts
            #working:
            # 1. self.ingestion_config.train_data_path=artifacts/train.csv
            # 2. os.path.dirname extracts the directory name i.e artifacts
